...
public class OrderServiceImpl implements OrderService {
    ...
    public OrderModel createOrder(Integer userId, Integer itemId, Integer promoId, Integer amount) throws BusinessException {
        ...
        if(userModel == null){
            throw new BusinessException(EmBusinessError.USER_NOT_EXIST,"用户信息不存在");
        }
        ...
        System.out.println("生成交易流水号"+orderModel.getId());
        orderDOMapper.insertSelective(orderDO);
        System.out.println("交易信息插入成功");
    ...
    @Override
    public List<OrderModel> getAllOrderByUserId(Integer userId) throws BusinessException {
